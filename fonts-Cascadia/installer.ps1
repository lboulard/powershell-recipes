...
$location = (Get-RecipesConfig).GetFetchLocation('fonts-cascadia')

$version = Get-ChildItem $location -File -Filter "CascadiaCode-*" | ForEach-Object {
    if ($_.Name -match '(\d+(\.\d+)+)\.zip$') { $Matches[1] }
} | Sort-Object -Descending -Property {
    [Version]$_
} | Select-Object -First 1

$release = "CascadiaCode-${version}"
